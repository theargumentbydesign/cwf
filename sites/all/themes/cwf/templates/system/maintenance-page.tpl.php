...
<body id="maintenance">
<div id="page">  <p style="text-align:center;float:left;width:100%;margin:0 auto;padding-top:50px;"><a href="<?php print $front_page; ?>" title="<?php print t('Home'); ?>" rel="home" class="logo"><img src="<?php print $logo; ?>" alt="<?php print t('Home'); ?>" /></a></p>
<p style="text-align:center;float:left;width:100%;margin:0 auto;padding-top:50px;">The Care and Wellbeing Fund is open for business. </p>
<p style="text-align:center;float:left;width:100%;margin:0 auto;padding-top:50px;">Our website is in production and will be live soon.</p>
<p style="text-align:center;float:left;width:100%;margin:0 auto;padding-top:50px;">In the meantime please contact us at <a href="mailto:hello@careandwellbeingfund.co.uk">hello@careandwellbeingfund.co.uk</a>
 </p>
</div>
